...
class Payment {
  ...
  profitsharingaddreceiver(params) {
    ...
    return this._request(pkg, "profitsharingaddreceiver", true);
  }

  // 结束分账
  profitsharingfinish(params) {
    let pkg = {
      ...params,
      appid: this.appid,
      mch_id: this.mchid,
    ...
    return this._request(pkg, "profitsharingfinish", true);
  }

  // 查询分账结果
  profitsharingquery(params) {
    let pkg = {
      ...params,
      mch_id: this.mchid,
      nonce_str: util.generate(),
    ...
    return this._request(pkg, "profitsharingquery", true);
  }
}
